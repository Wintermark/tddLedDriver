...
TEST(LedDriver, OutOffBoundsTurnOnChangeNothing)
{
	LedDriver_TurnOn(-1);
	LedDriver_TurnOn(0);
	LedDriver_TurnOn(17);
	LedDriver_TurnOn(3141);
	TEST_ASSERT_EQUAL_HEX16(0x000, virtualLeds);
}
TEST(LedDriver, OutOffBoundsTurnOffChangeNothing)
{
	LedDriver_TurnAllOn();
	LedDriver_TurnOff(-1);
	LedDriver_TurnOff(0);
...
TEST(LedDriver, OutOffBoundsProducesRuntimeError)
{
	LedDriver_TurnOn(-1);
